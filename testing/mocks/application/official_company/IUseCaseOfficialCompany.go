...
// IUseCaseOfficialCompany is an autogenerated mock type for the IUseCaseOfficialCompany type
type IUseCaseOfficialCompany struct {
	mock.Mock
}

// CreateOfficialCompany provides a mock function with given fields: _a0, _a1
func (_m *IUseCaseOfficialCompany) CreateOfficialCompany(_a0 models.OfficialCompany, _a1 uuid.UUID) (*models.OfficialCompany, error) {
...
func (_m *IUseCaseOfficialCompany) GetAllCompaniesNames() ([]models.BriefCompany, error) {
	ret := _m.Called()
...
func (_m *IUseCaseOfficialCompany) GetMineCompany(_a0 uuid.UUID) (*models.OfficialCompany, error) {
	ret := _m.Called(_a0)
...
func (_m *IUseCaseOfficialCompany) GetOfficialCompany(_a0 uuid.UUID) (*models.OfficialCompany, error) {
	ret := _m.Called(_a0)
...
func (_m *IUseCaseOfficialCompany) SearchCompanies(_a0 models.CompanySearchParams) ([]models.OfficialCompany, error) {
	ret := _m.Called(_a0)
