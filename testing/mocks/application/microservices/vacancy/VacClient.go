...
// VacClient is an autogenerated mock type for the VacClient type
type VacClient struct {
	mock.Mock
}

// AddRecommendation provides a mock function with given fields: _a0, _a1
func (_m *VacClient) AddRecommendation(_a0 uuid.UUID, _a1 int) error {
...
func (_m *VacClient) CreateVacancy(_a0 models.Vacancy) (*models.Vacancy, error) {
	ret := _m.Called(_a0)
...
func (_m *VacClient) DeleteVacancy(id uuid.UUID, empId uuid.UUID) error {
...
func (_m *VacClient) GetRecommendation(_a0 uuid.UUID, _a1 int, _a2 int) ([]models.Vacancy, error) {
...
func (_m *VacClient) GetVacancy(_a0 uuid.UUID) (*models.Vacancy, error) {
	ret := _m.Called(_a0)
...
func (_m *VacClient) GetVacancyList(_a0 uint, _a1 uint, _a2 uuid.UUID, _a3 int) ([]models.Vacancy, error) {
...
func (_m *VacClient) GetVacancyTopSpheres(_a0 int32) ([]models.Sphere, *models.VacTopCnt, error) {
	ret := _m.Called(_a0)
...
func (_m *VacClient) SearchVacancies(_a0 models.VacancySearchParams) ([]models.Vacancy, error) {
	ret := _m.Called(_a0)
...
func (_m *VacClient) UpdateVacancy(_a0 models.Vacancy) (*models.Vacancy, error) {
	ret := _m.Called(_a0)
