...
func (_m *UseCase) AddFavorite(favoriteForEmpl models.FavoritesForEmpl) (*models.FavoriteID, error) {
...
// DeleteResume provides a mock function with given fields: resId, candId
func (_m *UseCase) DeleteResume(resId uuid.UUID, candId uuid.UUID) error {
...
func (_m *UseCase) GetByIdWithCand(id uuid.UUID) (*models.Resume, error) {
	ret := _m.Called(id)
...
// MakePdf provides a mock function with given fields: id
func (_m *UseCase) MakePdf(id uuid.UUID) error {
	ret := _m.Called(id)
...
func (_m *UseCase) Search(searchParams modelsresume.SearchParams) ([]models.BriefResumeInfo, error) {
	ret := _m.Called(searchParams)

	var r0 []models.BriefResumeInfo
	if rf, ok := ret.Get(0).(func(modelsresume.SearchParams) []models.BriefResumeInfo); ok {
		r0 = rf(searchParams)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.BriefResumeInfo)
