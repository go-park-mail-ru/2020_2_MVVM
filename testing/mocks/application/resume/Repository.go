...
func (_m *Repository) AddFavorite(favoriteForEmpl models.FavoritesForEmpl) (*models.FavoritesForEmpl, error) {
...
func (_m *Repository) SelectCandidate(candID uuid.UUID) (*models.Candidate, error) {
