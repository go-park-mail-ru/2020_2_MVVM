...
// GetFavoriteByVacancy provides a mock function with given fields: candId, vacId
func (_m *IUseCaseVacancy) GetFavoriteByVacancy(candId uuid.UUID, vacId uuid.UUID) (*models.FavoriteID, error) {
