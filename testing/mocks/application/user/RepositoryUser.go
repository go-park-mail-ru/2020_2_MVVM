...
// CreateUser provides a mock function with given fields: _a0, companyID
func (_m *RepositoryUser) CreateUser(_a0 models.User, companyID *uuid.UUID) (*models.User, error) {
	ret := _m.Called(_a0, companyID)

	var r0 *models.User
	if rf, ok := ret.Get(0).(func(models.User, *uuid.UUID) *models.User); ok {
		r0 = rf(_a0, companyID)
	} else {
		if ret.Get(0) != nil {
...
func (_m *RepositoryUser) DeleteUser(id uuid.UUID) error {
	ret := _m.Called(id)
