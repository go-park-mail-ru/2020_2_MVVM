...
func (_m *UseCase) GetAllFromResume(ResumeID uuid.UUID) ([]models.ExperienceCustomComp, error) {
	ret := _m.Called(ResumeID)
...
func (_m *UseCase) GetById(id string) (*models.ExperienceCustomComp, error) {
	ret := _m.Called(id)
