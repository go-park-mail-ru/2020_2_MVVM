...
func easyjson39b3a2f5DecodeGithubComGoParkMailRu20202MVVMGitApplicationModels3(in *jlexer.Lexer, out *BriefResumeInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson39b3a2f5EncodeGithubComGoParkMailRu20202MVVMGitApplicationModels3(out *jwriter.Writer, in BriefResumeInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
