...
func (_m *MockRepository) Create(resume models.Education) (*models.Education, error) {
...
func (_m *MockRepository) DropAllFromResume(resumeID uuid.UUID) error {
...
func (_m *MockRepository) GetAllFromResume(resumeID uuid.UUID) ([]models.Education, error) {
	ret := _m.Called(resumeID)
...
func (_m *MockRepository) GetById(id string) (*models.Education, error) {
	ret := _m.Called(id)
