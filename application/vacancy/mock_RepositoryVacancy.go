...
// MockRepositoryVacancy is an autogenerated mock type for the RepositoryVacancy type
type MockRepositoryVacancy struct {
	mock.Mock
}

// CreateVacancy provides a mock function with given fields: _a0
func (_m *MockRepositoryVacancy) CreateVacancy(_a0 models.Vacancy) (*models.Vacancy, error) {
	ret := _m.Called(_a0)
...
func (_m *MockRepositoryVacancy) GetVacancyById(_a0 uuid.UUID) (*models.Vacancy, error) {
	ret := _m.Called(_a0)
...
func (_m *MockRepositoryVacancy) GetVacancyList(_a0 uint, _a1 uint, _a2 uuid.UUID, _a3 int) ([]models.Vacancy, error) {
...
func (_m *MockRepositoryVacancy) SearchVacancies(_a0 models.VacancySearchParams) ([]models.Vacancy, error) {
	ret := _m.Called(_a0)
...
func (_m *MockRepositoryVacancy) UpdateVacancy(_a0 models.Vacancy) (*models.Vacancy, error) {
	ret := _m.Called(_a0)
