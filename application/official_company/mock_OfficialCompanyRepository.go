...
// MockOfficialCompanyRepository is an autogenerated mock type for the OfficialCompanyRepository type
type MockOfficialCompanyRepository struct {
	mock.Mock
}

// CreateOfficialCompany provides a mock function with given fields: _a0, _a1
func (_m *MockOfficialCompanyRepository) CreateOfficialCompany(_a0 models.OfficialCompany, _a1 uuid.UUID) (*models.OfficialCompany, error) {
...
func (_m *MockOfficialCompanyRepository) GetCompaniesList(_a0 uint, _a1 uint) ([]models.OfficialCompany, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockOfficialCompanyRepository) GetMineCompany(_a0 uuid.UUID) (*models.OfficialCompany, error) {
	ret := _m.Called(_a0)
...
func (_m *MockOfficialCompanyRepository) GetOfficialCompany(_a0 uuid.UUID) (*models.OfficialCompany, error) {
	ret := _m.Called(_a0)
...
func (_m *MockOfficialCompanyRepository) SearchCompanies(_a0 models.CompanySearchParams) ([]models.OfficialCompany, error) {
	ret := _m.Called(_a0)
